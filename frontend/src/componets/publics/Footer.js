...
export default function Footer() {
  ...
  <ul class="footer-list-top">
    <li>
      <h4 class="footer-list-header">About escheme</h4></li>
    ...
    <li><a href='' class="generic-anchor footer-list-anchor" itemprop="significantLink">SCHOLERSHIPS</a></li>

    <li><a href='' itemprop="significantLink" class="generic-anchor footer-list-anchor">NEW OPENINGS</a></li>

    <li><a href='' class="generic-anchor footer-list-anchor" itemprop="significantLink">PROGRANMS</a></li>
  </ul>
  <ul class="footer-list-top">
    <li>
      <h4 class="footer-list-header">The SCHEME Selection</h4></li>


    <li><a href='' class="generic-anchor footer-list-anchor">MINORITY SCHEME</a></li>
    <li><a href='' class="generic-anchor footer-list-anchor">MEANS SCHOLERSHIP</a></li>
    <li><a href='' class="generic-anchor footer-list-anchor">COLLEAGE</a></li>
    <li><a href='' class="generic-anchor footer-list-anchor">NEED BASED</a></li>
    <li><a href='' class="generic-anchor footer-list-anchor" target="_blank">ESCHEME & SCHOLERSHIP</a></li>
  </ul>
  <ul class="footer-list-top">
    <li id='help'>
    ...
    <li id='find-a-store'><a href='/shop/store-locator' class="generic-anchor footer-list-anchor" itemprop="significantLink">USES</a></li>
    ...
    <li id='order-tracking'><a href='/shop/order-status' itemprop="significantLink" class="generic-anchor footer-list-anchor">SHOLERSHIP STATUS</a></li>
  </ul>
